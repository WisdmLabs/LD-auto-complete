 ...
 */
class Ld_Custom_Auto_Complete_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/ld_custom_auto_complete-admin.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/ld_custom_auto_complete-admin.js', array( 'jquery' ), $this->version, false );
	}
}
